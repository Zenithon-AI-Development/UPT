...
from datasets.collators.amr_simformer_collator import AmrSimformerCollator
from functools import cached_property
...
class LagrangianSimformerTrainer(SgdTrainer):
    ...
    def input_shape(self):
        ...
        if collator is not None:
            assert isinstance(collator.collator, (LagrangianSimformerCollator, AmrSimformerCollator))
